...
@EnableJms
@ComponentScan({"messaging","category.jms"})
@Configuration
...
public class Config {
    ...
    public JmsTemplate jmsTemplate(@Qualifier("activeMQConnectionFactory") ConnectionFactory activeMQConnectionFactory,
                                   @Qualifier("activeMQQueue") Queue activeMQQueue) {
